...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Order getOrder = orderRepository.findOne(orderId);  //아이템 1개 조회
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        assertEquals("주문 취소된 상품은 그만큼 재고가 증가해야함", 10, item.getStockQuantity());
    }
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("안산", "항가울로", "88-1"));
        em.persist(member);
        return member;
    }
